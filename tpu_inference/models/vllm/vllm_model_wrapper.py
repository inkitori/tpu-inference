...
class VllmModelWrapper:
    ...
    def load_weights(self,
        ...
        if self.vllm_config.speculative_config and self.vllm_config.speculative_config.method in (
            ...
            # DFlash reuses the eagle3 aux-hidden-state hook;
            # set_eagle3_aux_hidden_state_layers reads the draft's
            # dflash_config.target_layer_ids (with the +1 output-of-layer
