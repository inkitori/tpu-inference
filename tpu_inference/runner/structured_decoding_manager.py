...
class StructuredDecodingManager:
    ...
    def prepare_structured_decoding_input(
        ...
        # NOTE: grammar_bitmask rows follow the scheduler-provided order of
        # structured_output_request_ids. Do NOT sort the ids: sorting
        # misaligns bitmask rows with requests in multi-request batches
        # (vllm-project/tpu-inference#1531 / PR #1563). Also advance the
        # mask index for requests missing from this batch so later rows
        # stay aligned.
