...
from tpu_inference.layers.common.process_weights.moe_weights import (  # noqa: E402
...
try:
    ...
    # Some vLLM builds wrap FusedMoE in a way that breaks subclassing on
    # CPU-only installs; skip rather than fail collection.
    pytest.skip(f"FusedMoE not subclassable with this vLLM build: {e}",
